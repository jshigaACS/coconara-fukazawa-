...
if(!isset($_COOKIE["last_access"])&&!isset($_COOKIE["new_last_access"])){
  // カウント処理を実行し，json を出力．
  counter();
  //cookieの設定
  //setcookie("new_last_access",1,time()+(60*60));
}elseif(isset($_COOKIE["last_access"]) || isset($_COOKIE["new_last_access"])){
  counter();
}
